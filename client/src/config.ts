...
import { HEIGHT_WORLD_SCALE, SEA_SURFACE_WORLD_Y, WATER_SURFACE_CLEARANCE } from './worldScale.ts';
...
export { HEIGHT_WORLD_SCALE, SEA_SURFACE_WORLD_Y, WATER_SURFACE_CLEARANCE };
...
export const SEA_DEPTH_CUE_FLOOR_FRACTION = 3 / 4;

export const SEA_DEPTH_CUE_FLOOR_HEIGHT = -SEA_COLUMN_DEPTH * SEA_DEPTH_CUE_FLOOR_FRACTION;

export const SEA_DEPTH_CUE_SPAN_BANDS = -SEA_DEPTH_CUE_FLOOR_HEIGHT / BAND_HEIGHT;
