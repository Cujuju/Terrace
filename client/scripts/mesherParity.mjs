 ...
 * are exempt too.
 */
function buildExemptMask(cpu, width, height) {
...
function compareBands(gpuImage, cpuImage) {
...
// ----------------------------------------------------------- shaded compare
// Gate 1's compare verbatim: a pixel matches if ANY pixel in the other image's
// 3x3 neighbourhood is within PIXEL_TOLERANCE on every channel, both directions.
...
function compareShaded(a, b, paint) {
