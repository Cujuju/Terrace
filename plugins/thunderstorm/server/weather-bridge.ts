// thunderstorm → weather, via THE CROSS-PLUGIN DEPENDENCY PATTERN
...
// say to weather is "thunderstorm is in the sky", and a hub that resolves later must
// still be told).
//
...
// the register: the world is CALM and nobody is told about the thunderstorm. Systems
...
// plugin removed the wind, not the thunderstorm.
...
export const WEATHER_UNAVAILABLE_WARNING =
  '[thunderstorm] weather plugin not available — thunderstorm will gather where it forms and never drift';
