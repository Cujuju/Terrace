// boats → fire, via THE CROSS-PLUGIN DEPENDENCY PATTERN.
//
...
// fire's ENTITY registry rather than its cell registry, because a boat sails
...
//
// DEGRADED BEHAVIOUR when fire is absent: boats do not burn. One warning, once.
//
...
export const FIRE_UNAVAILABLE_WARNING =
  '[boats] fire plugin not available — boats will not burn';
 ...
 * either in hand when this returns or is not running at all.
 *
