...
describe('entities payload parsing', () => {
  it('accepts well-formed entries, defaults a missing or unknown size to medium, strips the school, and drops malformed entries individually', () => {
    ...
    expect(parsed).toEqual([
      { id: 3, species: 'whale', x: 1.25, y: -2.5, heading: 1.5, size: 0 },
      { id: 4, species: 'fish', x: 0, y: 0, heading: 0, size: DEFAULT_SIZE_CLASS_INDEX },
      { id: 5, species: 'fish', x: 0, y: 0, heading: 0, size: DEFAULT_SIZE_CLASS_INDEX },
      { id: 6, species: 'fish', x: 0, y: 0, heading: 0, size: DEFAULT_SIZE_CLASS_INDEX },
      { id: 7, species: 'fish', x: 0, y: 0, heading: 0, size: DEFAULT_SIZE_CLASS_INDEX },
      { id: 8, species: 'fish', x: 0, y: 0, heading: 0, size: 0 },
      { id: 10, species: 'grazer', x: 1, y: 2, heading: 0.5, size: 1 },
    ]);
