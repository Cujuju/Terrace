// wildlife → fire, READ-DIRECTION: a structural parse of fire's `ignited`
...
// here ever runs, and animals are startled by sculpting alone — exactly the
// world this plugin had before fire existed.
//
...
// something this plugin could match against its own animals.
