...
// every cell at height 0, i.e. entirely water and entirely band 0, on which
// nothing this plugin does is observable. This adds the one thing flora needs: a
// height field with terraces in it, built through the same World.restore path a
// snapshot uses.
//
// It is a COPY of the equivalent helper in plugins/wildlife/test, not an import:
// a plugin must build and test with every other plugin deleted.
