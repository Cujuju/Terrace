...
// MAX_ACTIVE_SYSTEMS MOVED TO ../protocol.ts (2026-08-29): it is the cap the
// CLIENT half's draw budget is written against — one rig per live system, part
// B of docs/plans/frame-budget-growth-and-draw-calls.md — and a client half may
// not import a plugin's server half. Re-exported here so every importer that
// had it from this module keeps working.
import { MAX_ACTIVE_SYSTEMS } from '../protocol.ts';
