// pilgrims → fire, via THE CROSS-PLUGIN DEPENDENCY PATTERN.
//
...
// fire's ENTITY registry rather than its cell registry, because a peep walks
...
//
// DEGRADED BEHAVIOUR when fire is absent: peeps do not burn. One warning,
// once.
 ...
 */
export function registerPilgrimsFuel(source: unknown): void {
